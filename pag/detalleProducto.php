...
<body>
  <div class="container mt-4">
       <input type="text" name="txtidProducto" id="txtidProducto" hidden=""  value="<?php echo $_GET['idp']?>">



      <div class="col-12 col-lg-4">
        <button type="button" class="btn btn-success shadow" data-bs-toggle="modal" data-bs-target="#variedad">
          <i class="fa-solid fa-add"></i> Nueva variedad</button>
      </div>
